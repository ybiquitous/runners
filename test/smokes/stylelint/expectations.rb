...
Smoke.add_test(
  "no_config",
  {
    analyzer: { name: "stylelint", version: "12.0.0" },
    guid: "test-guid",
    timestamp: :_,
    type: "success",
    issues: [
      {
        ...
        links: %w[https://github.com/stylelint/stylelint/tree/12.0.0/lib/rules/color-no-invalid-hex],
        object: { severity: "error" },
        git_blame_info: nil
      },
      {
        ...
        links: %w[https://github.com/stylelint/stylelint/tree/12.0.0/lib/rules/selector-type-no-unknown],
        object: { severity: "error" },
        git_blame_info: nil
      }
    ]
...
Smoke.add_test(
  "without-css",
  { analyzer: { name: "stylelint", version: "12.0.0" }, guid: "test-guid", timestamp: :_, type: "success", issues: [] }
)
...
Smoke.add_test(
  "syntax-error",
  {
    ...
    issues: [
      ...
      {
        message: "Unexpected unknown property \"someattr\"",
        links: %w[https://github.com/stylelint/stylelint/tree/12.0.0/lib/rules/property-no-unknown],
        id: "property-no-unknown",
        path: "ok.css",
        object: { severity: "error" },
        git_blame_info: nil,
    ...
    issues: [
      {
        ...
        links: %w[https://github.com/stylelint/stylelint/tree/12.0.0/lib/rules/block-closing-brace-empty-line-before],
      ...
      {
        message: "Expected a trailing semicolon",
        links: %w[https://github.com/stylelint/stylelint/tree/12.0.0/lib/rules/declaration-block-trailing-semicolon],
        id: "declaration-block-trailing-semicolon",
        path: "test.scss",
        object: { severity: "error" },
        git_blame_info: nil,
...
Smoke.add_test(
  "npm_install_without_stylelint",
  {
    ...
    issues: [
      ...
      {
        message: "Expected indentation of 2 spaces",
        links: %w[https://github.com/stylelint/stylelint/tree/12.0.0/lib/rules/indentation],
        id: "indentation",
        path: "test.scss",
        object: { severity: "error" },
        git_blame_info: nil,
      ...
      {
        message: "Expected no more than 1 empty line",
        links: %w[https://github.com/stylelint/stylelint/tree/12.0.0/lib/rules/max-empty-lines],
        id: "max-empty-lines",
        path: "test.less",
        object: { severity: "error" },
        git_blame_info: nil,
      ...
      {
        message: "Expected empty line before rule",
        links: %w[https://github.com/stylelint/stylelint/tree/12.0.0/lib/rules/rule-empty-line-before],
        id: "rule-empty-line-before",
        path: "test.scss",
        object: { severity: "error" },
        git_blame_info: nil,
