  ...
  issues: [
    {
      ...
      links: ["https://github.com/stylelint/stylelint/tree/12.0.0/lib/rules/color-no-invalid-hex"],
      object: {severity: "error"},
      git_blame_info: nil,
    },
    {
      ...
      links: ["https://github.com/stylelint/stylelint/tree/12.0.0/lib/rules/selector-type-no-unknown"],
      object: {severity: "error"},
      git_blame_info: nil,
    }
  ]
...
Smoke.add_test('syntax-error', {
  ...
  issues: [
    { message: "Unclosed block",
      ...
      location: { start_line: 1 } },
    { message: "Unexpected unknown property \"someattr\"",
      links: ["https://github.com/stylelint/stylelint/tree/12.0.0/lib/rules/property-no-unknown"],
      id: "property-no-unknown",
      path: "ok.css",
      object: { severity: "error" },
      git_blame_info: nil,
...
Smoke.add_test('only_stylelintrc_without_packages', {
  ...
  issues: [
    { message: "Expected empty line before closing brace",
      links: ["https://github.com/stylelint/stylelint/tree/12.0.0/lib/rules/block-closing-brace-empty-line-before"],
    ...
    { message: "Expected a trailing semicolon",
      links: ["https://github.com/stylelint/stylelint/tree/12.0.0/lib/rules/declaration-block-trailing-semicolon"],
      id: "declaration-block-trailing-semicolon",
      path: "test.scss",
      object: { severity: "error" },
      git_blame_info: nil,
...
Smoke.add_test('npm_install_without_stylelint', {
  ...
  issues: [
    { message: "Expected a trailing semicolon",
      ...
      location: { start_line: 8 } },
    { message: "Expected indentation of 2 spaces",
      links: ["https://github.com/stylelint/stylelint/tree/12.0.0/lib/rules/indentation"],
      id: "indentation",
      path: "test.scss",
      object: { severity: "error" },
      git_blame_info: nil,
      location: { start_line: 2 } },
    { message: "Expected no more than 1 empty line",
      links: ["https://github.com/stylelint/stylelint/tree/12.0.0/lib/rules/max-empty-lines"],
      id: "max-empty-lines",
      path: "test.less",
      object: { severity: "error" },
      git_blame_info: nil,
    ...
    { message: "Unexpected unknown property \"font-color\"",
      ...
      location: { start_line: 6 } },
    { message: "Expected empty line before rule",
      links: ["https://github.com/stylelint/stylelint/tree/12.0.0/lib/rules/rule-empty-line-before"],
      id: "rule-empty-line-before",
      path: "test.scss",
      object: { severity: "error" },
      git_blame_info: nil,
