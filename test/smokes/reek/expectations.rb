  ...
  issues: [
    {
      ...
      links: %w[https://github.com/troessner/reek/blob/v5.6.0/docs/Duplicate-Method-Call.md],
      object: nil,
      git_blame_info: nil
    },
    {
  ...
  issues: [
    {
      ...
      links: %w[https://github.com/troessner/reek/blob/v5.6.0/docs/Module-Initialize.md],
      object: nil,
      git_blame_info: nil
    }
  ],
  ...
  issues: [
    {
      ...
      links: %w[https://github.com/troessner/reek/blob/v5.6.0/docs/Long-Parameter-List.md],
    ...
    },
    {
      ...
      links: %w[https://github.com/troessner/reek/blob/v5.6.0/docs/Nil-Check.md],
      id: "NilCheck",
      path: "summer.rb",
