    ...
    issues: [
      {
        ...
        links: %w[https://github.com/rubocop-hq/rubocop/blob/v0.78.0/manual/cops_lint.md#lintliteralascondition],
      ...
      },
      {
        ...
        links: %w[
          https://github.com/rubocop-hq/rubocop/blob/v0.78.0/manual/cops_lint.md#lintshadowingouterlocalvariable
        ],
      ...
      },
      {
        ...
        links: %w[
          ...
          https://github.com/rubocop-hq/rubocop/blob/v0.78.0/manual/cops_lint.md#lintuselessassignment
        ],
      ...
      },
      {
        ...
        links: %w[
          ...
          https://github.com/rubocop-hq/rubocop/blob/v0.78.0/manual/cops_style.md#stylestringhashkeys
        ],
  ...
  issues: [
    {
      ...
      "links": %w[https://github.com/rubocop-hq/rubocop/blob/v0.78.0/manual/cops_style.md#styledocumentation],
    ...
    issues: [
      {
        ...
        links: %w[https://github.com/rubocop-hq/rubocop/blob/v0.78.0/manual/cops_lint.md#lintmultiplecomparison],
    ...
    issues: [
      {
        ...
        links: %w[https://github.com/rubocop-hq/rubocop/blob/v0.78.0/manual/cops_lint.md#lintemptyensure],
        id: "Lint/EmptyEnsure",
        path: "drink.rb",
      ...
      },
      {
        ...
        links: %w[https://github.com/rubocop-hq/rubocop/blob/v0.78.0/manual/cops_lint.md#lintsafenavigationchain],
