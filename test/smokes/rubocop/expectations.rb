...
Smoke.add_test(
  ...
  { guid: "test-guid", timestamp: :_, type: "success", issues: [], analyzer: { name: "RuboCop", version: "0.79.0" } },
  warnings: [
    {
      message: <<~MSG,
        Sider tried to install `rubocop 0.60.0` according to your `Gemfile.lock`, but it installs `0.79.0` instead.
