...
Smoke.add_test(
  "syntax_error",
  { guid: "test-guid", timestamp: :_, type: "failure", message: :_, analyzer: { name: "phpmd", version: "2.7.0" } }
)
...
Smoke.add_test(
  "with_php_version",
  { guid: "test-guid", timestamp: :_, type: "success", issues: [], analyzer: { name: "phpmd", version: "2.7.0" } }
)
