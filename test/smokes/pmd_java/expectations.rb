...
Smoke.add_test("success", {
  ...
  timestamp: :_,
  type: "success",
  analyzer: { name: 'pmd_java', version: "6.18.0" },
  issues: [
    { message: "System.out.println is used",
      links: ["https://pmd.github.io/pmd-6.18.0/pmd_rules_java_bestpractices.html#systemprintln"],
    ...
    { message: "Do not use hard coded encryption keys",
      links: ["https://pmd.github.io/pmd-6.18.0/pmd_rules_java_security.html#hardcodedcryptokey"],
  ...
  { message: "Use of deprecated attribute 'VariableDeclaratorId/@Array' in XPath query", file: nil },
  { message: "Use of deprecated attribute 'VariableDeclaratorId/@ArrayDepth' in XPath query", file: nil },
])
...
Smoke.add_test("old-rulesets-style", {
  ...
  issues: [
    { message: "Parameter 'args' is not assigned and could be declared final",
      links: ["https://pmd.github.io/pmd-6.18.0/pmd_rules_java_codestyle.html#methodargumentcouldbefinal"],
...
Smoke.add_test("config", {
  ...
  issues: [
    ...
    { message: "Avoid short class names like Main",
      links: ["https://pmd.github.io/pmd-6.18.0/pmd_rules_java_codestyle.html#shortclassname"],
...
Smoke.add_test("duplicate-rule-name", {
  ...
  issues: [
    { message: "Comment is too large: Too many lines",
      links: ["https://pmd.github.io/pmd-6.18.0/pmd_rules_java_documentation.html#commentsize"],
  ...
  issues: [
    {
     ...
     links: ["https://pmd.github.io/pmd-6.18.0/pmd_rules_java_errorprone.html#avoidduplicateliterals"],
