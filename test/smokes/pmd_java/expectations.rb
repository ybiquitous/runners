...
Smoke.add_test("success", {
  ...
  issues: [
    { message: "System.out.println is used",
      links: ["https://pmd.github.io/pmd-6.20.0/pmd_rules_java_bestpractices.html#systemprintln"],
    ...
    { message: "Exceptions should not extend java.lang.Error",
      links: ["https://pmd.github.io/pmd-6.20.0/pmd_rules_java_design.html#donotextendjavalangerror"],
    ...
    { message: "Avoid calling finalize() explicitly",
      links: ["https://pmd.github.io/pmd-6.20.0/pmd_rules_java_errorprone.html#avoidcallingfinalize"],
    ...
    { message: "Use block level rather than method level synchronization",
      links: ["https://pmd.github.io/pmd-6.20.0/pmd_rules_java_multithreading.html#avoidsynchronizedatmethodlevel"],
    ...
    { message: "Do not add empty strings",
      links: ["https://pmd.github.io/pmd-6.20.0/pmd_rules_java_performance.html#addemptystring"],
    ...
    { message: "Do not use hard coded encryption keys",
      links: ["https://pmd.github.io/pmd-6.20.0/pmd_rules_java_security.html#hardcodedcryptokey"],
...
Smoke.add_test("old-rulesets-style", {
  ...
  issues: [
    { message: "Parameter 'args' is not assigned and could be declared final",
      links: ["https://pmd.github.io/pmd-6.20.0/pmd_rules_java_codestyle.html#methodargumentcouldbefinal"],
...
Smoke.add_test("config", {
  ...
  issues: [
    ...
    { message: "Avoid short class names like Main",
      links: ["https://pmd.github.io/pmd-6.20.0/pmd_rules_java_codestyle.html#shortclassname"],
...
Smoke.add_test("duplicate-rule-name", {
  ...
  issues: [
    { message: "Comment is too large: Too many lines",
      links: ["https://pmd.github.io/pmd-6.20.0/pmd_rules_java_documentation.html#commentsize"],
  ...
  issues: [
    {
      ...
      links: ["https://pmd.github.io/pmd-6.20.0/pmd_rules_java_errorprone.html#avoidduplicateliterals"],
