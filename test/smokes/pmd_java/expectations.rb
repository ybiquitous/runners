...
s.add_test(
  "success",
  type: "success",
  analyzer: { name: "PMD Java", version: "6.22.0" },
  issues: [
    {
      message: "Do not add empty strings",
      links: %w[https://pmd.github.io/pmd-6.22.0/pmd_rules_java_performance.html#addemptystring],
      id: "AddEmptyString",
      path: "src/Hello.java",
    ...
    },
    {
      ...
      links: %w[https://pmd.github.io/pmd-6.22.0/pmd_rules_java_errorprone.html#avoidcallingfinalize],
    ...
    },
    {
      ...
      links: %w[https://pmd.github.io/pmd-6.22.0/pmd_rules_java_multithreading.html#avoidsynchronizedatmethodlevel],
    ...
    },
    {
      ...
      links: %w[https://pmd.github.io/pmd-6.22.0/pmd_rules_java_design.html#donotextendjavalangerror],
    ...
    },
    {
      ...
      links: %w[https://pmd.github.io/pmd-6.22.0/pmd_rules_java_security.html#hardcodedcryptokey],
    ...
    },
    {
      ...
      links: %w[https://pmd.github.io/pmd-6.22.0/pmd_rules_java_bestpractices.html#systemprintln],
      id: "SystemPrintln",
      path: "src/Hello.java",
  ...
  issues: [
    {
      ...
      links: %w[https://pmd.github.io/pmd-6.22.0/pmd_rules_java_codestyle.html#methodargumentcouldbefinal],
...
s.add_test(
  ...
  issues: [
    ...
    },
    {
      ...
      links: %w[https://pmd.github.io/pmd-6.22.0/pmd_rules_java_codestyle.html#shortclassname],
      id: "ShortClassName",
      path: "src/Main.java",
  ...
  issues: [
    {
      ...
      links: %w[https://pmd.github.io/pmd-6.22.0/pmd_rules_java_documentation.html#commentsize],
      id: "CommentSize",
      path: "Main.java",
  ...
  issues: [
    {
      ...
      links: %w[https://pmd.github.io/pmd-6.22.0/pmd_rules_java_errorprone.html#avoidduplicateliterals],
