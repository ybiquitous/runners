...
s.add_test(
  ...
  analyzer: { name: "GolangCI-Lint", version: "1.26.0" }
)
...
s.add_test("no_error", type: "success", issues: [], analyzer: { name: "GolangCI-Lint", version: "1.26.0" })
...
s.add_test("no_go_file", type: "success", issues: [], analyzer: { name: "GolangCI-Lint", version: "1.26.0" })
...
s.add_test("tests", type: "success", issues: [], analyzer: { name: "GolangCI-Lint", version: "1.26.0" })
...
s.add_test("no-config", type: "success", issues: [], analyzer: { name: "GolangCI-Lint", version: "1.26.0" })
...
s.add_test("skip-files", type: "success", issues: [], analyzer: { name: "GolangCI-Lint", version: "1.26.0" })
