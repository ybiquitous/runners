...
Smoke.add_test("success", {
  ...
  timestamp: :_,
  type: "success",
  analyzer: {name: 'checkstyle', version: '8.26'},
  issues: [
    {
      message: "The name of the outer type and the file do not match.",
      links: ["https://checkstyle.org/config_misc.html#OuterTypeFilename"],
    ...
    },
    {
      ...
      links: ["https://checkstyle.org/config_misc.html#Indentation"],
  ...
  issues: [
    {
      ...
      links: ["https://checkstyle.org/config_misc.html#FinalParameters"],
    ...
    },
    {
      ...
      links: ["https://checkstyle.org/config_design.html#HideUtilityClassConstructor"],
    ...
    },
    {
      ...
      links: ["https://checkstyle.org/config_javadoc.html#JavadocPackage"],
    ...
    },
    {
      ...
      links: ["https://checkstyle.org/config_javadoc.html#MissingJavadocMethod"],
  ...
  issues: [
    {
      ...
      links: ["https://checkstyle.org/config_sizes.html#LineLength"],
